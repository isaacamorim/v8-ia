...
class Cliente(db.Model):
    ...
    JND_DESCRI = db.Column(db.String(255), nullable=False)
    JND_TIPCGC = db.Column(db.Integer)
    JND_NUMCGC = db.Column(db.String(14), unique=True, nullable=False)
    JMP_TIPEMP = db.Column(db.String(1), nullable=True)
    ...
    JMP_ENDID = db.Column(db.Integer, primary_key=True)
    JMP_NFANTA = db.Column(db.String(255), nullable=False)
